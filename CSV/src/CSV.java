...
public class CSV {
	...
	public static void main(String[] args) {
		...
		String csvFile = "C:\\Users\\kaluzhskayaas\\Desktop\\CSV\\1.csv";
		...
		try {
			...
			br2 = new BufferedWriter(new FileWriter("C:\\Users\\kaluzhskayaas\\Desktop\\CSV\\result.csv"));
			br.readLine();
			...
			File[] fList;
			File F = new File("C:\\Users\\kaluzhskayaas\\Desktop\\CSV\\folder");
			fList = F.listFiles();
			boolean flag = true;
			for (int i = 0; i < fList.length; i++) {
				...
				while ((line = br.readLine()) != null) {
					...
					for (Company item : companies) {
						if (item.getNumber()== Integer.parseInt(str[1])) {
							A = item;
							break;
						}
					}
					...
					Company B=null;
					for (Company item : companies) {
						if (item.getNumber()== Integer.parseInt(str[3])) {
							B = item;
							break;
						}
					}
